...
pasifik/calibration/progress; this page only shows that and asks for the next
...
from competitions.international_uav.widgets.calibration_card import CalibrationCard
...
class CalibrationPanel(QWidget):
    ...
    def show_progress(self, progress: dict) -> None:
        ...
        self.state_pill.show_status(state, PILL_STATES.get(state, STATE_IDLE))
        self.name_label.setText(
